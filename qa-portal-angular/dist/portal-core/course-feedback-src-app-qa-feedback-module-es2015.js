...
class FormPage {
    constructor(formService, errorHandlerService, router, route, summaryUrl) {
    ...
    questionsAnswered(categoryResponse) {
...
let EvaluationService = class EvaluationService {
    ...
    getForm(cohortCourseId) {
        return this.qaHttp.get({ ref: 'GET_EVALUATION_FOR_TRAINEE_AND_COURSE', params: { cohortCourseId } });
    }
...
let FormTypeService = class FormTypeService {
    ...
    getFormType(formName) {
        return this.qaHttp.get({ ref: 'GET_FORM_TYPE', params: { formName } });
    }
    /**
...
let TrainerCourseHistoryService = class TrainerCourseHistoryService {
    constructor(qaHttp) {
        this.qaHttp = qaHttp;
    }
    getCourseHistory() {
...
TrainerCourseHistoryService.ctorParameters = () => [
    { type: projects_portal_core_src_app_common_services_qa_http_service__WEBPACK_IMPORTED_MODULE_2__["QaHttpService"] }
];
...
let CourseEvaluationComponent = class CourseEvaluationComponent {
    constructor() { }
    ngOnInit() {
    }
};
...
let EvaluationTableComponent = class EvaluationTableComponent {
    constructor() {
...
let QaFeedbackRoutingModule = class QaFeedbackRoutingModule {
};
...
let QaFeedbackModule = class QaFeedbackModule {
};
...
let TraineeCourseEvaluationComponent = class TraineeCourseEvaluationComponent extends _common_form_page__WEBPACK_IMPORTED_MODULE_5__["FormPage"] {
    constructor(evaluationService, errorHandlerService, router, route) {
...
TraineeCourseEvaluationComponent.ctorParameters = () => [
...
let TraineeEvaluationSummaryService = class TraineeEvaluationSummaryService {
    constructor(qaHttp) {
        this.qaHttp = qaHttp;
    }
    getTraineeEvaluationSummary() {
        return this.qaHttp.get({ ref: 'GET_TRAINEE_EVALUATION_SUMMARY' });
    }
};
TraineeEvaluationSummaryService.ctorParameters = () => [
    { type: projects_portal_core_src_app_common_services_qa_http_service__WEBPACK_IMPORTED_MODULE_2__["QaHttpService"] }
];
...
let TraineeEvaluationSummaryComponent = class TraineeEvaluationSummaryComponent {
    constructor(traineeEvaluationSummaryService, errorHandlerService) {
    ...
    ngOnInit() {
        this.getEvaluationSummarySubscription = this.traineeEvaluationSummaryService.getTraineeEvaluationSummary().subscribe((response) => {
            this.viewModel = response;
            this.dataSource = new _angular_material__WEBPACK_IMPORTED_MODULE_4__["MatTableDataSource"](this.viewModel.evaluationSummaryRows);
    ...
    getEvaluationUrl(cohortCourseId) {
        return '/qa/portal/training/feedback/trainee/evaluation/' + cohortCourseId;
    }
};
TraineeEvaluationSummaryComponent.ctorParameters = () => [
...
let RetrieveTrainerEvaluationHistoryService = class RetrieveTrainerEvaluationHistoryService {
    constructor(qaHttp) {
        this.qaHttp = qaHttp;
    }
    getEvalHistory() {
...
RetrieveTrainerEvaluationHistoryService.ctorParameters = () => [
    { type: projects_portal_core_src_app_common_services_qa_http_service__WEBPACK_IMPORTED_MODULE_2__["QaHttpService"] }
];
...
let TrainerEvaluationHistoryComponent = class TrainerEvaluationHistoryComponent {
    constructor(retrieveTrainerEvalHistory, errorHandler) {
        this.retrieveTrainerEvalHistory = retrieveTrainerEvalHistory;
        this.errorHandler = errorHandler;
        this.dataLoading = true;
    }
    ngOnInit() {
        this.retrieveTrainerEvalHistory.getEvalHistory().subscribe((response) => {
...
TrainerEvaluationHistoryComponent.ctorParameters = () => [
...
let TrainerEvaluationService = class TrainerEvaluationService {
    constructor(qaHttp) {
        this.qaHttp = qaHttp;
    }
    getTrainerCourseEvaluationSummary(courseId) {
        return this.qaHttp.get({ ref: 'GET_TRAINER_EVALUATION_SUMMARY', params: { courseId: courseId.toString() } });
    }
};
TrainerEvaluationService.ctorParameters = () => [
    { type: projects_portal_core_src_app_common_services_qa_http_service__WEBPACK_IMPORTED_MODULE_2__["QaHttpService"] }
];
...
let TrainerEvaluationSummaryComponent = class TrainerEvaluationSummaryComponent {
    constructor(trainerEvaluationService, activatedRoute) {
...
TrainerEvaluationSummaryComponent.ctorParameters = () => [
...
class TrainerFeedbackHistoryModel {
}
...
let TrainerFeedbackHistoryComponent = class TrainerFeedbackHistoryComponent {
    constructor(trainerCourseHistoryService, errorHandlerService) {
    ...
    ngOnInit() {
        this.trainerCourseHistoryService.getCourseHistory().subscribe((response) => {
            this.viewModel = new _models_trainer_feedback_history_model__WEBPACK_IMPORTED_MODULE_5__["TrainerFeedbackHistoryModel"]();
            this.viewModel.cohortCourses = response.cohortCourseHistory;
            this.dataSource = new _angular_material__WEBPACK_IMPORTED_MODULE_2__["MatTableDataSource"](this.viewModel.cohortCourses);
            this.dataLoading = false;
        }, (error) => {
            this.dataLoading = false;
            this.errorHandlerService.handleError(error);
...
TrainerFeedbackHistoryComponent.ctorParameters = () => [
...
let TrainerFeedbackPageComponent = class TrainerFeedbackPageComponent extends _common_form_page__WEBPACK_IMPORTED_MODULE_5__["FormPage"] {
    constructor(feedbackService, errorHandlerService, router, route) {
...
TrainerFeedbackPageComponent.ctorParameters = () => [
...
let ControlFactoryComponent = class ControlFactoryComponent {
    ...
    loadControl() {
        ...
        const componentFactory = this.componentFactoryResolver.resolveComponentFactory(_common_models_control_constants__WEBPACK_IMPORTED_MODULE_3__["CONTROLS_MAP"][this.question.selectionType || this.type]);
        ...
        componentRef.instance.questionResponseChange
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["takeWhile"])(() => this.keepAlive))
            .subscribe(event => {
            // this.questionResponseChange.emit(event);
        });
    }
};
ControlFactoryComponent.ctorParameters = () => [
...
let CheckBoxComponent = class CheckBoxComponent extends _generic_control_generic_control_component__WEBPACK_IMPORTED_MODULE_2__["GenericControlComponent"] {
    ngOnInit() {
    }
    /**
     ...
     */
    setCheckResponse({ checked, source: { value } }) {
        if (checked) {
    ...
    matchesValue(option, responseValues) {
...
let GenericControlComponent = class GenericControlComponent {
    constructor() {
        this.questionResponseChange = new _angular_core__WEBPACK_IMPORTED_MODULE_1__["EventEmitter"]();
    }
    announceChange() {
...
let RadioButtonComponent = class RadioButtonComponent extends _generic_control_generic_control_component__WEBPACK_IMPORTED_MODULE_2__["GenericControlComponent"] {
    ngOnInit() {
    }
...
let FormComponent = class FormComponent {
    ...
    onCategoryChange(categoryResponse, index) {
...
let QaFormsModule = class QaFormsModule {
};
...
//# sourceMappingURL=course-feedback-src-app-qa-feedback-module-es2015.js.map