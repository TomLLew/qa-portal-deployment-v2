...
var ERROR_MSG_PARM = 'errorMsg';
var QaErrorPageComponent = /** @class */ (function () {
    function QaErrorPageComponent(route) {
        this.route = route;
        this.error = this.route.snapshot.queryParams[ERROR_MSG_PARM];
    }
    QaErrorPageComponent.ctorParameters = function () { return [
...
var QaErrorRoutingModule = /** @class */ (function () {
    function QaErrorRoutingModule() {
    }
...
var QaErrorModule = /** @class */ (function () {
    function QaErrorModule() {
    }
...
//# sourceMappingURL=qa-error-app-src-app-qa-error-module-es5.js.map