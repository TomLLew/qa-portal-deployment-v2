...
let DataTableComponent = class DataTableComponent {
    ...
    onRowCheckboxClicked(event, index) {
        ...
        if (event.shiftKey && this.lastSelectionIndex !== null) { // SHIFT click
            ...
            for (const i of lodash__WEBPACK_IMPORTED_MODULE_3__["range"](this.lastSelectionIndex, index)) {
...
let ExpanderDirective = class ExpanderDirective {
...
ExpanderDirective.ctorParameters = () => [
...
let TitleDirective = class TitleDirective {
    constructor(template, viewContainer) {
        this.template = template;
        this.viewContainer = viewContainer;
    }
...
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_30__ = __webpack_require__(/*! @angular/core */ "../../node_modules/@angular/core/fesm2015/core.js");
...
/* harmony import */ var _angular_platform_browser__WEBPACK_IMPORTED_MODULE_34__ = __webpack_require__(/*! @angular/platform-browser */ "../../node_modules/@angular/platform-browser/fesm2015/platform-browser.js");
...
/* harmony import */ var _angular_material_moment_adapter__WEBPACK_IMPORTED_MODULE_40__ = __webpack_require__(/*! @angular/material-moment-adapter */ "../../node_modules/@angular/material-moment-adapter/esm2015/material-moment-adapter.js");
...
/* harmony import */ var _angular_cdk_drag_drop__WEBPACK_IMPORTED_MODULE_42__ = __webpack_require__(/*! @angular/cdk/drag-drop */ "../../node_modules/@angular/cdk/esm2015/drag-drop.js");
...
let QaCommonModule = class QaCommonModule {
    constructor(matIconRegistry, domSanitizer) {
        this.matIconRegistry = matIconRegistry;
        this.domSanitizer = domSanitizer;
        for (const icon of _common_models_icons_model__WEBPACK_IMPORTED_MODULE_45__["customIcons"]) {
            this.matIconRegistry.addSvgIcon(icon.name, this.domSanitizer.bypassSecurityTrustResourceUrl(icon.path));
        }
    }
};
QaCommonModule.ctorParameters = () => [
...
let RatedQuestionComponent = class RatedQuestionComponent {
    constructor() {
...
let SearchBarBackdropComponent = class SearchBarBackdropComponent {
    constructor() {
        this.show = false;
...
let AppAuthGuard = class AppAuthGuard extends keycloak_angular__WEBPACK_IMPORTED_MODULE_3__["KeycloakAuthGuard"] {
    constructor(router, keycloakAngular, toasterService) {
...
class PortalApplicationProjectsModel {
    constructor() {
        this.portalProjects = [];
    }
}
...
let ApplicationService = class ApplicationService {
    ...
    onApplicationLoaded() {
        ...
        Object(rxjs__WEBPACK_IMPORTED_MODULE_2__["combineLatest"])(this.portalApplications$, this.router.events.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["filter"])(e => e instanceof _angular_router__WEBPACK_IMPORTED_MODULE_3__["NavigationEnd"])) // Filter out the events we don't care about
        ).subscribe(([apps, routerEvent]) => {
    ...
    getCurrentApplicationByRoute(apps, event) {
...
let QaErrorHandlerService = class QaErrorHandlerService {
    constructor(router, toastrService, dialog) {
        this.router = router;
        this.toastrService = toastrService;
        this.dialog = dialog;
    }
    handleError(error) {
        this.processError(error).subscribe((done) => {
...
QaErrorHandlerService.ctorParameters = () => [
    { type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"] },
...
let QaHelpService = class QaHelpService {
...
let QaHttpService = class QaHttpService {
    ...
    buildUrl(url) {
        if (typeof url === 'object') {
            let constructedUrl = _environments_endpoints__WEBPACK_IMPORTED_MODULE_3__["endpoints"][url.ref] || '/ERROR_NO_URL_FOUND';
    ...
    get(url, options) {
        return this.httpClient.get(this.buildUrl(url), Object.assign({}, this.DEFAULT_HTTP_OPTIONS, options));
    }
    post(url, body, options) {
        return this.httpClient.post(this.buildUrl(url), body, Object.assign({}, this.DEFAULT_HTTP_OPTIONS, options));
    }
    put(url, body, options) {
        return this.httpClient.put(this.buildUrl(url), body, Object.assign({}, this.DEFAULT_HTTP_OPTIONS, options));
    }
    patch(url, body, options) {
        return this.httpClient.patch(this.buildUrl(url), body, Object.assign({}, this.DEFAULT_HTTP_OPTIONS, options));
    }
    delete(url, options) {
        return this.httpClient.delete(this.buildUrl(url), Object.assign({}, this.DEFAULT_HTTP_OPTIONS, options));
    }
};
QaHttpService.ctorParameters = () => [
...
let QaToastrService = class QaToastrService {
    constructor(toastr) {
        this.toastr = toastr;
    }
    showSuccess(msg) {
...
QaToastrService.ctorParameters = () => [
...
const routes = [
    ...
    // Add routes for new application here
    {
        ...
        loadChildren: () => Promise.all(/*! import() | course-feedback-src-app-qa-feedback-module */[__webpack_require__.e("common"), __webpack_require__.e("course-feedback-src-app-qa-feedback-module")]).then(__webpack_require__.bind(null, /*! ../../../course-feedback/src/app/qa-feedback.module */ "../course-feedback/src/app/qa-feedback.module.ts")).then(mod => mod.QaFeedbackModule)
    },
    {
        path: 'qa/portal/training/self-reflection',
        loadChildren: () => Promise.all(/*! import() | self-reflection-src-app-qa-self-reflection-module */[__webpack_require__.e("default~qa-admin-src-app-qa-admin-module~self-reflection-src-app-qa-self-reflection-module"), __webpack_require__.e("self-reflection-src-app-qa-self-reflection-module")]).then(__webpack_require__.bind(null, /*! ../../../self-reflection/src/app/qa-self-reflection.module */ "../self-reflection/src/app/qa-self-reflection.module.ts")).then(mod => mod.QaSelfReflectionModule)
    },
    {
        path: 'qa/portal/training/cv',
        loadChildren: () => __webpack_require__.e(/*! import() | qa-cv-src-app-qa-cv-module */ "qa-cv-src-app-qa-cv-module").then(__webpack_require__.bind(null, /*! ../../../qa-cv/src/app/qa-cv.module */ "../qa-cv/src/app/qa-cv.module.ts")).then(mod => mod.QaCvModule)
    },
    {
        path: 'qa/portal/admin',
        loadChildren: () => Promise.all(/*! import() | qa-admin-src-app-qa-admin-module */[__webpack_require__.e("default~qa-admin-src-app-qa-admin-module~self-reflection-src-app-qa-self-reflection-module"), __webpack_require__.e("common"), __webpack_require__.e("qa-admin-src-app-qa-admin-module")]).then(__webpack_require__.bind(null, /*! ../../../qa-admin/src/app/qa-admin.module */ "../qa-admin/src/app/qa-admin.module.ts")).then(mod => mod.QaAdminModule)
    },
    {
        path: 'error',
        loadChildren: () => __webpack_require__.e(/*! import() | qa-error-app-src-app-qa-error-module */ "qa-error-app-src-app-qa-error-module").then(__webpack_require__.bind(null, /*! ../../../qa-error-app/src/app/qa-error.module */ "../qa-error-app/src/app/qa-error.module.ts")).then(mod => mod.QaErrorModule)
    },
    {
        path: '',
        pathMatch: 'full',
...
/* harmony import */ var keycloak_angular__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! keycloak-angular */ "../../node_modules/keycloak-angular/fesm2015/keycloak-angular.js");
...
let PortalApplicationHomeComponent = class PortalApplicationHomeComponent {
    constructor(sideMenuService, appService, QaHelpService) {
        this.sideMenuService = sideMenuService;
        this.appService = appService;
        this.QaHelpService = QaHelpService;
    }
};
PortalApplicationHomeComponent.ctorParameters = () => [
...
let PortalFooterComponent = class PortalFooterComponent {
    constructor() { }
    ngOnInit() {
    }
};
...
let PortalHeaderComponent = class PortalHeaderComponent {
    constructor(appService, keycloak, QaHelpService) {
        this.appService = appService;
...
PortalHeaderComponent.ctorParameters = () => [
...
let PortalHelpContentComponent = class PortalHelpContentComponent {
    constructor(helpService, router) {
...
PortalHelpContentComponent.ctorParameters = () => [
...
let PortalHelpComponent = class PortalHelpComponent {
    constructor(keycloak, helpService, router) {
        this.keycloak = keycloak;
        this.helpService = helpService;
        this.router = router;
...
PortalHelpComponent.ctorParameters = () => [
    { type: keycloak_angular__WEBPACK_IMPORTED_MODULE_2__["KeycloakService"] },
    { type: _common_services_qa_help_service__WEBPACK_IMPORTED_MODULE_3__["QaHelpService"] },
...
let PortalHomeComponent = class PortalHomeComponent {
    constructor(sideMenuService, appService) {
        this.sideMenuService = sideMenuService;
        this.appService = appService;
    }
};
PortalHomeComponent.ctorParameters = () => [
...
let PortalSideMenuContentComponent = class PortalSideMenuContentComponent {
    constructor(appService, sideMenuService, QaHelpService) {
        this.appService = appService;
        this.sideMenuService = sideMenuService;
        this.QaHelpService = QaHelpService;
...
PortalSideMenuContentComponent.ctorParameters = () => [
    { type: _common_services_application_service__WEBPACK_IMPORTED_MODULE_3__["ApplicationService"] },
    { type: _common_services_side_menu_service__WEBPACK_IMPORTED_MODULE_2__["SideMenuService"] },
    { type: _common_services_qa_help_service__WEBPACK_IMPORTED_MODULE_4__["QaHelpService"] }
];
...
let PortalSideMenuComponent = class PortalSideMenuComponent {
    constructor(sideMenuService, helpService) {
        this.sideMenuService = sideMenuService;
        this.helpService = helpService;
...
PortalSideMenuComponent.ctorParameters = () => [
    { type: _common_services_side_menu_service__WEBPACK_IMPORTED_MODULE_3__["SideMenuService"] },
    { type: _common_services_qa_help_service__WEBPACK_IMPORTED_MODULE_4__["QaHelpService"] }
];
