...
/*!*******************************************************************************************************************************************!*\
  !*** /home/qa-admin/Documents/qa-portal-deployment/frontend/qa-portal-angular/node_modules/angular-calendar/fesm2015/angular-calendar.js ***!
  \*******************************************************************************************************************************************/
...
/*!*****************************************************************************************************************************************************************!*\
  !*** /home/qa-admin/Documents/qa-portal-deployment/frontend/qa-portal-angular/node_modules/angular-draggable-droppable/fesm2015/angular-draggable-droppable.js ***!
  \*****************************************************************************************************************************************************************/
...
/*!*************************************************************************************************************************************************************!*\
  !*** /home/qa-admin/Documents/qa-portal-deployment/frontend/qa-portal-angular/node_modules/angular-resizable-element/fesm2015/angular-resizable-element.js ***!
  \*************************************************************************************************************************************************************/
...
let UserService = class UserService {
    ...
    addUser(user) {
        const userDetails = new _portal_core_src_app_common_models_user_details_model__WEBPACK_IMPORTED_MODULE_3__["UserDetailsModel"]();
...
let AppProjectDetailComponent = class AppProjectDetailComponent {
    constructor(appService, roleService, aR, dialog, toastr, errorService) {
    ...
    ngOnInit() {
        ...
        Object(rxjs__WEBPACK_IMPORTED_MODULE_9__["forkJoin"])(this.appService.getProjectById(projectId), this.roleService.getPortalRoleNames()).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["take"])(1), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["finalize"])(() => this.isLoading = false)).subscribe(([project, roles]) => {
    ...
    onSaveProjectClicked() {
        ...
        this.isLoading = true;
        this.appService.saveProject(project).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["take"])(1), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["finalize"])(() => this.isLoading = false)).subscribe(() => {
    ...
    onRemovePageClicked(page) {
        this.dialog.open(_delete_page_confirm_dialog_delete_page_confirm_dialog_component__WEBPACK_IMPORTED_MODULE_12__["DeletePageConfirmDialogComponent"]).afterClosed().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["take"])(1)).subscribe(data => {
            if (data) {
...
AppProjectDetailComponent.ctorParameters = () => [
...
let DeletePageConfirmDialogComponent = class DeletePageConfirmDialogComponent {
    constructor() { }
    ngOnInit() {
    }
};
...
let AppProjectManagementComponent = class AppProjectManagementComponent {
    constructor(router, activatedRoute, appService, errorService, dialog) {
        this.router = router;
    ...
    performSearch() {
        ...
        this.appService.getAllProjects().subscribe(results => {
            this.projectsTableDataSource.data = results;
            this.isLoading = false;
        }, err => this.errorService.handleError(err));
    }
    onAddProjectButtonClicked() {
        this.dialog.open(_new_project_dialog_new_project_dialog_component__WEBPACK_IMPORTED_MODULE_7__["NewProjectDialogComponent"], {}).afterClosed().subscribe(data => {
            if (data) {
                this.performSearch();
            }
        });
...
AppProjectManagementComponent.ctorParameters = () => [
...
let NewProjectDialogComponent = class NewProjectDialogComponent {
    constructor(appService, dialogRef, errorService) {
        this.appService = appService;
    ...
    onSubmit() {
        this.isLoading = true;
        this.appService.addProject(this.projectForm.value).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["take"])(1), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["finalize"])(() => this.isLoading = false)).subscribe(project => this.dialogRef.close(project), err => this.errorService.handleError(err));
    }
};
NewProjectDialogComponent.ctorParameters = () => [
...
let ApplicationDetailComponent = class ApplicationDetailComponent {
    constructor(appService, errorService, aR, toastr, router) {
        this.appService = appService;
        this.errorService = errorService;
        this.aR = aR;
        this.toastr = toastr;
    ...
    ngOnInit() {
        ...
        this.appService.getApplicationById(appId).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["take"])(1), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["finalize"])(() => this.isLoading = false)).subscribe(app => {
            this.app = app;
            this.appForm.patchValue(this.app.portalApplication);
        }, err => this.errorService.handleError(err));
    }
    onSaveAppClicked() {
        const app = Object.assign({}, this.app.portalApplication, this.appForm.value);
        this.isLoading = true;
...
let ApplicationManagementComponent = class ApplicationManagementComponent {
    constructor(router, activatedRoute, appService, errorService, dialog) {
        this.router = router;
        this.activatedRoute = activatedRoute;
        this.appService = appService;
    ...
    onAddAppButtonClicked() {
        this.dialog.open(_new_app_dialog_new_app_dialog_component__WEBPACK_IMPORTED_MODULE_6__["NewAppDialogComponent"], {}).afterClosed().subscribe(data => {
            if (data) {
                this.performSearch();
            }
        });
...
ApplicationManagementComponent.ctorParameters = () => [
    { type: _angular_router__WEBPACK_IMPORTED_MODULE_4__["Router"] },
    { type: _angular_router__WEBPACK_IMPORTED_MODULE_4__["ActivatedRoute"] },
...
let NewAppDialogComponent = class NewAppDialogComponent {
    constructor(appService, dialogRef, errorService) {
        this.appService = appService;
        this.dialogRef = dialogRef;
        this.errorService = errorService;
    ...
    onSubmit() {
        this.isLoading = true;
        this.appService.addApplication(this.appForm.value).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["take"])(1), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["finalize"])(() => this.isLoading = false)).subscribe(app => this.dialogRef.close(app), err => this.errorService.handleError(err));
    }
};
NewAppDialogComponent.ctorParameters = () => [
    { type: _common_services_application_service__WEBPACK_IMPORTED_MODULE_3__["ApplicationService"] },
...
let AddCourseDialogComponent = class AddCourseDialogComponent {
    constructor(data) {
        this.data = data;
    }
    ngOnInit() {
...
AddCourseDialogComponent.ctorParameters = () => [
...
let CohortDetailComponent = class CohortDetailComponent {
    constructor(cohortService, courseService, locationService, aR, dialog, toastr, errorService) {
    ...
    ngOnInit() {
        ...
        Object(rxjs__WEBPACK_IMPORTED_MODULE_4__["forkJoin"])(this.cohortService.getCohortById(cohortId), this.courseService.getAllCourses(), this.cohortService.getAvailableTrainersForCohort(), this.locationService.getAllLocations(), this.cohortService.getAvailableTraineesByCohortId(cohortId)).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["take"])(1))
            ...
            this.viewDate = moment__WEBPACK_IMPORTED_MODULE_2__(cohort.startDate).toDate();
            this.cohortForm.patchValue(cohort);
            this.isLoading = false;
            this.cohortForm.enable();
        }, (err) => this.errorService.handleError(err));
        this.cohortForm.valueChanges.subscribe(v => {
            this.cohort = Object.assign({}, this.cohort, v);
        });
    }
    cohortCourseToCalendarEvent(course) {
        const startMom = moment__WEBPACK_IMPORTED_MODULE_2__(course.startDate).utc().add(moment__WEBPACK_IMPORTED_MODULE_2__(course.startDate).utcOffset(), 'm');
        return {
    ...
    calendarEventToCohortCourse(calendarEvent) {
        return Object.assign({}, calendarEvent.meta, { startDate: moment__WEBPACK_IMPORTED_MODULE_2__(calendarEvent.start).format('YYYY-MM-DD'), endDate: moment__WEBPACK_IMPORTED_MODULE_2__(calendarEvent.end).format('YYYY-MM-DD') });
    }
    buildCohortCourse(course, startDate, endDate, trainer, location) {
        return {
    ...
    onCalendarStartClicked() {
        this.viewDate = moment__WEBPACK_IMPORTED_MODULE_2__(this.cohort.startDate).toDate();
        this.refreshCalendar.next();
    }
    eventClicked(_a) {
        var { event } = _a, rest = tslib__WEBPACK_IMPORTED_MODULE_0__["__rest"](_a, ["event"]);
        const dialog = this.dialog.open(_edit_course_dialog_edit_course_dialog_component__WEBPACK_IMPORTED_MODULE_14__["EditCourseDialogComponent"], {
            data: {
    ...
    dayClicked({ day }) {
        const dialog = this.dialog.open(_add_course_dialog_add_course_dialog_component__WEBPACK_IMPORTED_MODULE_11__["AddCourseDialogComponent"], {
            data: {
                availableCourses: this.availableCourses,
                availableTrainers: this.availableTrainers,
                availableLocations: this.availableLocations
        ...
        dialog.beforeClosed().subscribe(data => {
            if (data) {
                this.calendarEvents.push(this.cohortCourseToCalendarEvent(this.buildCohortCourse(data.selectedCourse, day.date, moment__WEBPACK_IMPORTED_MODULE_2__(day.date).add((data.selectedDuration || 1) - 1, 'days').toDate(), data.selectedTrainer, data.selectedLocation)));
                this.refreshCalendar.next();
            }
        });
    }
    onSaveCohortClicked() {
        this.cohort = Object.assign({}, this.cohort, this.cohortForm.value, { cohortCourses: this.calendarEvents.map(e => this.calendarEventToCohortCourse(e)) });
        this.cohortService.saveCohort(this.cohort).subscribe(resp => {
            this.toastr.showSuccess('Cohort updated');
        }, err => this.errorService.handleError(err));
    }
};
CohortDetailComponent.ctorParameters = () => [
...
EditCourseDialogComponent.ctorParameters = () => [
    { type: undefined, decorators: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_1__["Inject"], args: [_angular_material__WEBPACK_IMPORTED_MODULE_2__["MAT_DIALOG_DATA"],] }] },
...
let CohortManagementComponent = class CohortManagementComponent {
    constructor(router, activatedRoute, cohortService, errorService, dialog) {
        this.router = router;
        this.activatedRoute = activatedRoute;
        this.cohortService = cohortService;
        this.errorService = errorService;
    ...
    onAddCohortButtonClicked() {
        this.dialog.open(_new_cohort_dialog_new_cohort_dialog_component__WEBPACK_IMPORTED_MODULE_6__["NewCohortDialogComponent"], {}).afterClosed().subscribe(data => {
            if (data) {
                this.performSearch();
            }
        });
...
CohortManagementComponent.ctorParameters = () => [
...
let NewCohortDialogComponent = class NewCohortDialogComponent {
    constructor(cohortService, errorService, dialogRef) {
        this.cohortService = cohortService;
        this.errorService = errorService;
        this.dialogRef = dialogRef;
        this.availableTrainers = [];
    ...
    ngOnInit() {
        this.cohortService.getAvailableTrainersForCohort().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["take"])(1), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["finalize"])(() => this.isLoading = false)).subscribe(trainers => this.availableTrainers = trainers, err => this.errorService.handleError(err));
    }
    onSubmit() {
        const newCohort = Object.assign({}, this.cohortForm.value);
        this.cohortService.addCohort(newCohort)
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["take"])(1), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["finalize"])(() => this.isLoading = false)).subscribe(cohort => this.dialogRef.close(cohort), err => this.errorService.handleError(err));
    }
};
NewCohortDialogComponent.ctorParameters = () => [
    { type: _common_services_cohort_service__WEBPACK_IMPORTED_MODULE_3__["CohortService"] },
    { type: projects_portal_core_src_app_common_services_qa_error_handler_service__WEBPACK_IMPORTED_MODULE_4__["QaErrorHandlerService"] },
...
let CourseDetailComponent = class CourseDetailComponent {
    constructor(courseService, techService, aR, errorService, toastr) {
        this.courseService = courseService;
    ...
    ngOnInit() {
        Object(rxjs__WEBPACK_IMPORTED_MODULE_8__["forkJoin"])(this.courseService.getCourseById(this.aR.snapshot.params.id), this.techService.getAllCategories())
            ...
            .subscribe(([course, techCats]) => {
            this.course = course;
            this.availableTechCategories = techCats;
            this.courseForm.patchValue(Object.assign({}, this.course, { courseTechnologies: this.course.courseTechnologies.map(c => c.technology.id) }));
        }, err => this.errorService.handleError(err));
    }
    onSaveCourseClicked() {
        this.course = Object.assign({}, this.course, this.courseForm.value, { courseTechnologies: this.techIdArrayToCourseTechArray(this.courseForm.value.courseTechnologies) });
    ...
    techIdArrayToCourseTechArray(ids) {
        return this.availableTechCategories
            .reduce((prev, curr) => [...prev, ...curr.technologies], [])
...
let CourseManagementComponent = class CourseManagementComponent {
    constructor(router, activatedRoute, courseService, errorService, dialog) {
        this.router = router;
        this.activatedRoute = activatedRoute;
        this.courseService = courseService;
        this.errorService = errorService;
    ...
    onAddCourseButtonClicked() {
        const dialogRef = this.dialog.open(_new_course_dialog_new_course_dialog_component__WEBPACK_IMPORTED_MODULE_6__["NewCourseDialogComponent"]);
...
CourseManagementComponent.ctorParameters = () => [
    { type: _angular_router__WEBPACK_IMPORTED_MODULE_4__["Router"] },
    { type: _angular_router__WEBPACK_IMPORTED_MODULE_4__["ActivatedRoute"] },
...
let NewCourseDialogComponent = class NewCourseDialogComponent {
    constructor(courseService, techService, dialogRef, errorService) {
        this.courseService = courseService;
        this.techService = techService;
        this.dialogRef = dialogRef;
        this.errorService = errorService;
    ...
    ngOnInit() {
        this.techService.getAllCategories().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["take"])(1), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["finalize"])(() => this.isLoading = false)).subscribe(cats => this.availableTechCategories = cats, err => this.errorService.handleError(err));
    }
    onSubmit() {
        this.isLoading = true;
        const newCourse = Object.assign({}, this.courseForm.value, { courseTechnologies: [] });
        this.courseService.saveCourse(newCourse).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["take"])(1), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["finalize"])(() => this.isLoading = false)).subscribe(course => this.dialogRef.close(course), err => this.errorService.handleError(err));
    }
};
NewCourseDialogComponent.ctorParameters = () => [
    { type: _common_services_course_service__WEBPACK_IMPORTED_MODULE_3__["CourseService"] },
...
let FormDetailComponent = class FormDetailComponent {
    constructor(formService, errorService, aR, toastr) {
    ...
    ngOnInit() {
        this.formService.getFormById(this.aR.snapshot.params.id)
            ...
            .subscribe(form => {
            this.form = form;
            this.formForm.patchValue(Object.assign({}, this.form));
        }, err => this.errorService.handleError(err));
    }
    ...
    onSaveFormClicked() {
        const form = Object.assign({}, this.form, this.formForm.value);
        this.formService.saveForm(form).subscribe(resp => {
            this.toastr.showSuccess('Form updated');
        }, err => this.errorService.handleError(err));
    }
};
FormDetailComponent.ctorParameters = () => [
...
let FormManagementComponent = class FormManagementComponent {
    constructor(router, activatedRoute, formService, errorService, dialog) {
        this.router = router;
        this.activatedRoute = activatedRoute;
        this.formService = formService;
        this.errorService = errorService;
    ...
    onAddFormButtonClicked() {
        this.dialog.open(_new_form_dialog_new_form_dialog_component__WEBPACK_IMPORTED_MODULE_6__["NewFormDialogComponent"], {}).afterClosed().subscribe(data => {
            if (data) {
                this.performSearch();
            }
        });
    ...
    getQuestionCount(cats) {
        return cats ? cats.map(cat => cat.questions).reduce((prev, curr) => prev + curr.length || 0, 0) : 0;
    }
};
...
let NewFormDialogComponent = class NewFormDialogComponent {
    constructor(formService, dialogRef, errorService) {
        this.formService = formService;
        this.dialogRef = dialogRef;
        this.errorService = errorService;
        this.isLoading = false;
    ...
    onSubmit() {
        this.isLoading = true;
        this.formService.addForm(this.formForm.value).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["take"])(1), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["finalize"])(() => this.isLoading = false)).subscribe(form => this.dialogRef.close(form), err => this.errorService.handleError(err));
    }
};
NewFormDialogComponent.ctorParameters = () => [
...
let LocationDetailComponent = class LocationDetailComponent {
    constructor(locationService, aR, errorService, toastr) {
        this.locationService = locationService;
        this.aR = aR;
        this.errorService = errorService;
        this.toastr = toastr;
...
LocationDetailComponent.ctorParameters = () => [
...
let LocationManagementComponent = class LocationManagementComponent {
    constructor(locationService, dialog, activatedRoute, router, errorService) {
        this.locationService = locationService;
        this.dialog = dialog;
        this.activatedRoute = activatedRoute;
        this.router = router;
    ...
    onAddLocationButtonClicked() {
        const dialogRef = this.dialog.open(_new_location_dialog_new_location_dialog_component__WEBPACK_IMPORTED_MODULE_7__["NewLocationDialogComponent"]);
        dialogRef.afterClosed().subscribe(result => {
            if (result) {
                this.performSearch();
            }
...
LocationManagementComponent.ctorParameters = () => [
    { type: _common_services_location_service__WEBPACK_IMPORTED_MODULE_2__["LocationService"] },
    { type: _angular_material__WEBPACK_IMPORTED_MODULE_3__["MatDialog"] },
    { type: _angular_router__WEBPACK_IMPORTED_MODULE_5__["ActivatedRoute"] },
    { type: _angular_router__WEBPACK_IMPORTED_MODULE_5__["Router"] },
...
let NewLocationDialogComponent = class NewLocationDialogComponent {
    constructor(locationService, dialogRef, errorService) {
        this.locationService = locationService;
        this.dialogRef = dialogRef;
        this.errorService = errorService;
        this.isLoading = false;
    ...
    onSubmit() {
        this.isLoading = true;
        this.locationService.addLocation(this.locationForm.value).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["take"])(1), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["finalize"])(() => this.isLoading = false)).subscribe(location => this.dialogRef.close(location), err => this.errorService.handleError(err));
    }
};
NewLocationDialogComponent.ctorParameters = () => [
    { type: _common_services_location_service__WEBPACK_IMPORTED_MODULE_2__["LocationService"] },
    { type: _angular_material__WEBPACK_IMPORTED_MODULE_4__["MatDialogRef"] },
    { type: projects_portal_core_src_app_common_services_qa_error_handler_service__WEBPACK_IMPORTED_MODULE_5__["QaErrorHandlerService"] }
];
...
let QaAdminRoutingModule = class QaAdminRoutingModule {
};
...
let QaAdminModule = class QaAdminModule {
};
...
let RoleDetailComponent = class RoleDetailComponent {
    constructor(roleService, appService, aR, errorService, toastr) {
        this.roleService = roleService;
        this.appService = appService;
        this.aR = aR;
        this.errorService = errorService;
    ...
    ngOnInit() {
        Object(rxjs__WEBPACK_IMPORTED_MODULE_9__["forkJoin"])(this.roleService.getRoleById(this.aR.snapshot.params.id), this.appService.getAllApplications())
            ...
            this.roleForm.patchValue(Object.assign({}, this.role, { portalApplication: lodash__WEBPACK_IMPORTED_MODULE_10__["get"](this.role, ['portalApplication', 'id'], null) }));
        }, err => this.errorService.handleError(err));
    }
    onSaveRoleClicked() {
        this.role = Object.assign({}, this.role, this.roleForm.value, { portalApplication: this.availableApps.find(app => app.id === this.roleForm.value.portalApplication) });
...
let NewRoleDialogComponent = class NewRoleDialogComponent {
    constructor(roleService, appService, dialogRef, errorService) {
        this.roleService = roleService;
        this.appService = appService;
        this.dialogRef = dialogRef;
        this.errorService = errorService;
    ...
    ngOnInit() {
        this.appService.getAllApplications().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["take"])(1), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["finalize"])(() => this.isLoading = false)).subscribe(apps => {
            this.availableApps = apps;
        });
    }
    onSubmit() {
        this.isLoading = true;
        this.roleService.addRole(this.roleForm.value).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["take"])(1), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["finalize"])(() => this.isLoading = false)).subscribe(role => this.dialogRef.close(role), err => this.errorService.handleError(err));
    }
};
NewRoleDialogComponent.ctorParameters = () => [
    { type: _common_services_role_service__WEBPACK_IMPORTED_MODULE_3__["RoleService"] },
...
let RoleManagementComponent = class RoleManagementComponent {
    constructor(roleService, dialog, activatedRoute, router, errorService) {
        this.roleService = roleService;
        this.dialog = dialog;
        this.activatedRoute = activatedRoute;
        this.router = router;
    ...
    onAddRoleButtonClicked() {
        const dialogRef = this.dialog.open(_new_role_dialog_new_role_dialog_component__WEBPACK_IMPORTED_MODULE_3__["NewRoleDialogComponent"]);
        dialogRef.afterClosed().subscribe(result => {
            if (result) {
                this.performSearch();
            }
...
let TechnologyDetailComponent = class TechnologyDetailComponent {
    constructor(techService, aR, errorService, toastr) {
        this.techService = techService;
        this.aR = aR;
        this.errorService = errorService;
        this.toastr = toastr;
    ...
    onSaveCategoryClicked() {
        this.techCategory = Object.assign({}, this.techCategory, this.technologyForm.value, { technologies: this.technologies });
        this.technologyForm.disable();
        this.isLoading = true;
...
TechnologyDetailComponent.ctorParameters = () => [
...
let NewCategoryDialogComponent = class NewCategoryDialogComponent {
    constructor(techService, dialogRef, errorService) {
        this.techService = techService;
        this.dialogRef = dialogRef;
        this.errorService = errorService;
        this.isLoading = true;
    ...
    onSubmit() {
        this.isLoading = true;
        const newCat = Object.assign({}, this.catForm.value);
        this.techService.addCategory(newCat)
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["take"])(1), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["finalize"])(() => this.isLoading = false)).subscribe(cat => this.dialogRef.close(cat), err => this.errorService.handleError(err));
    }
};
NewCategoryDialogComponent.ctorParameters = () => [
...
let TechnologyManagementComponent = class TechnologyManagementComponent {
    constructor(router, activatedRoute, techService, errorService, dialog) {
        this.router = router;
        this.activatedRoute = activatedRoute;
        this.techService = techService;
        this.errorService = errorService;
    ...
    onAddCategoryButtonClicked() {
        const dialogRef = this.dialog.open(_new_category_dialog_new_category_dialog_component__WEBPACK_IMPORTED_MODULE_6__["NewCategoryDialogComponent"]);
        dialogRef.afterClosed().subscribe(result => {
            if (result) {
                this.performSearch();
                // this.isLoading = true;
...
TechnologyManagementComponent.ctorParameters = () => [
    { type: _angular_router__WEBPACK_IMPORTED_MODULE_5__["Router"] },
    { type: _angular_router__WEBPACK_IMPORTED_MODULE_5__["ActivatedRoute"] },
...
let UserDetailComponent = class UserDetailComponent {
    constructor(rolesService, userService, aR, errorService, toastr) {
    ...
    onSubmit() {
        this.isLoading = true;
        this.userForm.disable();
        const userData = Object.assign({}, this.fetchedUser, this.userForm.value, { user: Object.assign({}, this.fetchedUser.user, this.userForm.value.user) });
...
let AddUserDialogComponent = class AddUserDialogComponent {
    constructor(dialogRef, rolesService, errorService, userService) {
        this.dialogRef = dialogRef;
        this.rolesService = rolesService;
        this.errorService = errorService;
        this.userService = userService;
...
AddUserDialogComponent.ctorParameters = () => [
    { type: _angular_material__WEBPACK_IMPORTED_MODULE_2__["MatDialogRef"] },
...
let DeleteUserDialogComponent = class DeleteUserDialogComponent {
...
DeleteUserDialogComponent.ctorParameters = () => [
    { type: _angular_material__WEBPACK_IMPORTED_MODULE_2__["MatDialogRef"] },
...
let UpdateUserCohortDialogComponent = class UpdateUserCohortDialogComponent {
    constructor(dialogRef, cohortService, errorService, data) {
        this.dialogRef = dialogRef;
        this.cohortService = cohortService;
        this.errorService = errorService;
        this.data = data;
...
UpdateUserCohortDialogComponent.ctorParameters = () => [
    { type: _angular_material__WEBPACK_IMPORTED_MODULE_2__["MatDialogRef"] },
    { type: _common_services_cohort_service__WEBPACK_IMPORTED_MODULE_3__["CohortService"] },
...
let UpdateUserRoleDialogComponent = class UpdateUserRoleDialogComponent {
    constructor(dialogRef, data, rolesService, errorService) {
        this.dialogRef = dialogRef;
        this.data = data;
        this.rolesService = rolesService;
        this.errorService = errorService;
...
UpdateUserRoleDialogComponent.ctorParameters = () => [
    { type: _angular_material__WEBPACK_IMPORTED_MODULE_2__["MatDialogRef"] },
    { type: String, decorators: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_1__["Inject"], args: [_angular_material__WEBPACK_IMPORTED_MODULE_2__["MAT_DIALOG_DATA"],] }] },
    { type: _common_services_role_service__WEBPACK_IMPORTED_MODULE_3__["RoleService"] },
    { type: _portal_core_src_app_common_services_qa_error_handler_service__WEBPACK_IMPORTED_MODULE_4__["QaErrorHandlerService"] }
...
let UserManagementComponent = class UserManagementComponent {
    constructor(dialog, userService, activatedRoute, errorService, router) {
        this.dialog = dialog;
        this.userService = userService;
        this.activatedRoute = activatedRoute;
        this.errorService = errorService;
    ...
    onDeleteActionClicked() {
        ...
        const dialogRef = this.dialog.open(_delete_user_dialog_delete_user_dialog_component__WEBPACK_IMPORTED_MODULE_6__["DeleteUserDialogComponent"], { data: users });
        dialogRef.afterClosed().subscribe(result => {
            if (result) {
                this.isLoading = true;
    ...
    onAddUserClicked() {
        const dialogRef = this.dialog.open(_add_user_dialog_add_user_dialog_component__WEBPACK_IMPORTED_MODULE_7__["AddUserDialogComponent"], {});
...
//# sourceMappingURL=qa-admin-src-app-qa-admin-module-es2015.js.map